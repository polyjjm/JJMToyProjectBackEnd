...
//                oauth로그인이 성공했을경우 실행할 클래스 정의
    ...
    public CorsConfigurationSource configurationSource(){
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "http://3.36.127.136:80" , "http://3.36.127.136:8020" , "http://3.36.127.136:3000","http://jjmdev.co.kr:8020","http://jjmdev.co.kr:80","http://jjmdev.co.kr:3000"));
